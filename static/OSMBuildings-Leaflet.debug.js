...
var Buildings = {
  ...
  render: function( colorController ) {
...
var Layers = {
  ...
  render: function( colorController ) {
    colorController = colorController || this.OSMBD;
    Shadows.render();
    Simplified.render();
    Buildings.render( colorController );
  },
...
// Added 5.17.14
proto.refresh = function( dataManager ) {
  Layers.render( dataManager );
  return this;
}
